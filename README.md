...
3. Select a project name( Click on "Import").

4. On Configure Project page Hit deploy !

Your app is now running on Vercel.

Example, the React app I deployed is accessible at https://psg-roster-react-challenge.vercel.app/.
